...
function analyzeUserPosts(users) {
  const oneWeekAgo = new Date("2024-05-07T00:00:00");
  ...
  const averageLikesPerUser = activeUsers.length
...
const result = analyzeUserPosts(users);
console.log(result);
